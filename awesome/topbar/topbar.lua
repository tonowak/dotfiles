...
local task_list = require('topbar.widget.task-list')
local tag_list = require('topbar.widget.tag-list')
...
local bottom_panel = function(s)
	...
	s.clock_widget = wibox.widget.textclock(
		'<span font="SF Pro Text Bold 11"> %H:%M </span>',
		1
	)
	...
	s.tray_toggler  = require('topbar.widget.tray-toggler')
	s.network      	= require('topbar.widget.network')()
	-- s.battery     	= require('topbar.widget.battery')()
	s.search     	= require('topbar.widget.search-apps')()
	s.end_session   = require('topbar.widget.end-session')()
	-- s.side_settings = require('topbar.widget.side-settings')()
	-- s.r_dashboard 	= require('layout.right-panel.right-panel-opener')()
	s.volume		= require('topbar.widget.volume')()
