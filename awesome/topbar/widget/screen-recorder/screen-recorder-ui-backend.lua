...
local screen_rec_backend = require('topbar.widget.screen-recorder.screen-recorder-scripts')


-- The screen-recorder's UI
local screen_rec_ui = require('topbar.widget.screen-recorder.screen-recorder-ui')
